...
async def play(_, message: Message):
    global que
    lel = await message.reply("**wait lemme Play The Song**")
    ...
    await lel.edit("Wait Lemme find The Song 👨‍💻")
    sender_id = message.from_user.id
    ...
    for i in message.command[1:]:
        query += ' ' + str(i)
    print(query)
    await lel.edit("**wait lemme Play The Song**")
    ...
    requested_by = message.from_user.first_name
        ...
        try:
            ...
            await lel.edit(file="https://telegra.ph/file/2712366a91363caed77a2.jpg", toxxt,reply_markup=koyboard,disable_web_page_preview=True)
